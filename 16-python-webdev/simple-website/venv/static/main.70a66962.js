				...
				(n.VERSION = "3.3.7"),
					...
					(n.prototype.init = function (e, n, i) {
						if (
							...
							(this.$viewport =
								this.options.viewport && t(t.isFunction(this.options.viewport) ? this.options.viewport.call(this, this.$element) : this.options.viewport.selector || this.options.viewport)),
				...
				for (var n, i, o = [], r = 0, s = t.length; r < s; r++)
					(i = t[r]),
						i.style &&
							((n = i.style.display),
							e
								? ("none" === n && ((o[r] = Ht.get(i, "display") || null), o[r] || (i.style.display = "")), "" === i.style.display && zt(i) && (o[r] = x(i)))
				...
				for (var r, s, a, l, u, c, p = e.createDocumentFragment(), f = [], d = 0, h = t.length; d < h; d++)
					if ((r = t[d]) || 0 === r)
						if ("object" === yt.type(r)) yt.merge(f, r.nodeType ? [r] : r);
							...
							for (
								s = s || p.appendChild(e.createElement("div")), a = (Qt.exec(r) || ["", ""])[1].toLowerCase(), l = Kt[a] || Kt._default, s.innerHTML = l[1] + yt.htmlPrefilter(r) + l[2], c = l[0];
								c--;
					...
					for (
						...
						if ((n = w.relative[t[a].type])) c = [f(d(c), n)];
							...
							if (((n = w.filter[t[a].type].apply(null, t[a].matches)), n[H])) {
								...
								return m(
									a > 1 && d(c),
									a > 1 && p(t.slice(0, a - 1).concat({ value: " " === t[a - 2].type ? "*" : "" })).replace(rt, "$1"),
									n,
									a < i && v(t.slice(a, i)),
									i < o && v((t = t.slice(i))),
									i < o && p(t)
							...
							preFilter: {
								...
								PSEUDO: function (t) {
									...
									return pt.CHILD.test(t[0])
										? null
										: (t[3] ? (t[2] = t[4] || t[5] || "") : n && ut.test(n) && (e = k(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && ((t[0] = t[0].slice(0, e)), (t[2] = n.slice(0, e))),
										  t.slice(0, 3));
								},
							},
							filter: {
													...
													if (((h = [s ? m.firstChild : m.lastChild]), s && y)) {
														...
														for (
															...
															((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) ||
																!++b ||
																(y && ((p = f[H] || (f[H] = {})), (c = p[f.uniqueID] || (p[f.uniqueID] = {})), (c[t] = [M, b])), f !== e));
					...
					if (m && (l = m.events)) {
						for (e = (e || "").match(It) || [""], u = e.length; u--; )
							if (((a = ne.exec(e[u]) || []), (d = g = a[1]), (h = (a[2] || "").split(".").sort()), d)) {
								for (
									p = yt.event.special[d] || {}, d = (i ? p.delegateType : p.bindType) || d, f = l[d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = f.length;
									r--;
						...
						for (s = yt.event.handlers.call(this, a, u), e = 0; (o = s[e++]) && !a.isPropagationStopped(); )
							for (a.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !a.isImmediatePropagationStopped(); )
								(a.rnamespace && !a.rnamespace.test(r.namespace)) ||
									((a.handleObj = r),
									(a.data = r.data),
									void 0 !== (i = ((yt.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
						...
						return "boolean" == typeof e && "string" === n
							...
							: this.each(function () {
									...
									if ("string" === n) for (i = 0, o = yt(this), r = t.match(It) || []; (e = r[i++]); ) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
										...
										(void 0 !== t && "boolean" !== n) ||
											((e = J(this)), e && Ht.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Ht.get(this, "__className__") || ""));
							  });
					},
					hasClass: function (t) {
						var e,
			...
			yt.fn.extend({
				val: function (t) {
						...
						o = this[0];
					{
						...
						if (o)
							return (e = yt.valHooks[o.type] || yt.valHooks[o.nodeName.toLowerCase()]) && "get" in e && void 0 !== (n = e.get(o, "value"))
								? n
							...
							return (
								"fixed" === yt.css(n, "position")
									...
									: ((t = this.offsetParent()),
									  ...
									  (i = { top: i.top + yt.css(t[0], "borderTopWidth", !0), left: i.left + yt.css(t[0], "borderLeftWidth", !0) })),
						...
						.on("click.bs.button.data-api", '[data-toggle^="button"]', function (n) {
							...
							e.call(i, "toggle"),
								t(n.target).is('input[type="radio"], input[type="checkbox"]') ||
									(n.preventDefault(), i.is("input,button") ? i.trigger("focus") : i.find("input:visible,button:visible").first().trigger("focus"));
						})
